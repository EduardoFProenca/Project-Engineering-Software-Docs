# 💼📊 Sistema Hermes Calçados - Documentação e Prototipação
...
> 📄 **[Clique aqui para visualizar o PDF completo](docs/Engenharia_de_Software_Versao_Final.pdf)**
...
1. **Fase 1 - Solicitação**: Recebimento e análise da demanda do cliente
2. **Fase 2 - Pesquisa**: Entrevistas com 4 stakeholders (Estoquista, Vendedora, Caixa e Gerente)
3. **Fase 3 - Análise**: Mapeamento da situação atual e identificação de problemas
4. **Fase 4 - Requisitos**: Definição de requisitos funcionais e não funcionais
5. **Fase 5 - Prototipação**: Criação de 31 telas de interface
6. **Fase 6 - Versão Final**: Correções, ajustes e documentação completa (84 páginas)
